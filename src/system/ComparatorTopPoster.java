...
public class ComparatorTopPoster implements Comparator<User> {
	 ...
	 * @return 1 if user the has more posts than the topPoster, if there is a tie,
	 * 1 if the user has wrote more comments than the topPoster, if there is still a tie,
	 * 1 if the user's id is alphabetically first than the topPoster's id.
	 */
