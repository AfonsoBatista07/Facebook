...
public class ComparatorResponsive implements Comparator<User> {
	 ...
	 * @return >0 if user has a higher percentage of commented posts than the responsive,
	 * if there is a draw, if the user's id is alphabetically first than the responsive's id.
	 */
